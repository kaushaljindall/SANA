            ...
            <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-12">
                <div className="w-full max-w-md animate-fade-in-up">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sana-text-muted text-sm tracking-widest uppercase">Create your account</p>
                    </div>
                    ...
                    <div className="glass-panel p-8 space-y-6">
                        <form onSubmit={handleRegister} className="space-y-4">
                            {/* Name */}
                            <div>
                                <label className="text-sana-text/70 text-xs uppercase font-bold tracking-wider mb-2 block">Full Name</label>
                                <div className="relative">
                                    <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-sana-text-muted" />
                                    <input
                                        type="text"
                                        value={formData.name}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-4 top-1/2 -translate-y-1/2 text-sana-text-muted hover:text-white transition-colors"
                                    >
                                ...
                                {formData.password && (
                                    <div className="mt-2 flex items-center gap-2">
                                        ...
                                        <span className={`text-[10px] uppercase font-bold tracking-wider ${strength.strength === 'weak' ? 'text-red-400' :
                            ...
                            {/* Confirm Password */}
                            <div>
                                <label className="text-sana-text/70 text-xs uppercase font-bold tracking-wider mb-2 block">Confirm Password</label>
                                <div className="relative">
                                    <Lock className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-sana-text-muted" />
                                    <input
                                        type={showPassword ? 'text' : 'password'}
                                    ...
                                    {formData.confirmPassword && formData.password === formData.confirmPassword && (
                                        <CheckCircle className="absolute right-4 top-1/2 -translate-y-1/2 w-5 h-5 text-emerald-400 animate-pulse" />
                                    )}
                                </div>
                            </div>
                        ...
                        <p className="text-center text-sana-text-muted text-sm">
                            ...
                            <Link to="/login" className="text-sana-primary hover:text-sana-accent font-bold transition-colors">
                                Sign in
                            </Link>
                        </p>
                    </div>
